...
1. **Obtain Your Cluster-Specific Operator Manifest:**
   ...
   ```sh
   # Download from Kubetrace dashboard or CLI
   kubetrace operator download --cluster-id <your-cluster-id> -o kubetrace-operator.yaml
   ```

   Alternatively, copy the manifest directly from your dashboard's operator configuration page.
...
- **Documentation:** Visit [docs.kubetrace.net](https://docs.kubetrace.net) for detailed guides
- **Support Portal:** Create tickets at [support.kubetrace.net](https://support.kubetrace.net)
- **Community Forums:** Join discussions at [community.kubetrace.net](https://community.kubetrace.net)
- **Email Support:** Contact support@kubetrace.net for urgent issues
